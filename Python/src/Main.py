...
def main():
    file_manager1 = FileManager1()
    courses = file_manager1.read_course("Java Project/Iteration_2/src/Jsons/compulsoryCourses.json")
    ...
    course_registration_simulation = CourseRegistrationSimulation()
