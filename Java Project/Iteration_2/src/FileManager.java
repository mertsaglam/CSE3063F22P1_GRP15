...
public class FileManager {
	...
	public ArrayList<Iteration_1.src.Student> readStudent(String path) {
		...
		ArrayList<Iteration_1.src.Student> students = new ArrayList<Iteration_1.src.Student>();
	...
	public ArrayList<Iteration_1.src.Course> readCourse(String path) {
		...
		ArrayList<Iteration_1.src.Course> courses = new ArrayList<Iteration_1.src.Course>();
	...
	public ArrayList<Iteration_1.src.Lecturer> readLecturer(String path) {
		...
		ArrayList<Iteration_1.src.Lecturer> lecturers = new ArrayList<Iteration_1.src.Lecturer>();
	...
	public ArrayList<Iteration_1.src.Advisor> readAdvisor(String path) {
		...
		ArrayList<Iteration_1.src.Advisor> advisors = new ArrayList<Iteration_1.src.Advisor>();
	...
	public Iteration_1.src.Student initializeStudent(JSONObject jsonObject){
		...
		Iteration_1.src.Transcript transcript = jsonToClassTranscript(jsonObject.get("transcript").toString());
		Semester semester = jsonToClassSemester(jsonObject.get("semester").toString());
		Iteration_1.src.Schedule schedule = jsonToClassSchedule(jsonObject.get("schedule").toString());
		Iteration_1.src.Advisor advisor = jsonToClassAdvisor(jsonObject.get("advisor").toString());
	...
	public Iteration_1.src.Schedule initializeSchedule(JSONObject jsonObject){
	...
	public Iteration_1.src.Lecturer initializeLecturer(JSONObject jsonObject){

		Gson gson = new Gson();
		Type courseListType = new TypeToken<ArrayList<Iteration_1.src.Student>>(){}.getType();
	...
	public Iteration_1.src.Advisor initializeAdvisor(JSONObject jsonObject){

		Gson gson = new Gson();
		Type courseListType = new TypeToken<ArrayList<Iteration_1.src.Student>>(){}.getType();
		ArrayList<Iteration_1.src.Student> advisedStudents = gson.fromJson(jsonObject.get("advisedStudents").toString(),courseListType);
	...
	public Iteration_1.src.Transcript initializeTranscript(JSONObject jsonObject){
		Gson gson = new Gson();
		...
		Type courseListType = new TypeToken<ArrayList<Iteration_1.src.Course>>(){}.getType();
		ArrayList<Iteration_1.src.Course> takenCourses = gson.fromJson(jsonObject.get("takenCourses").toString(),courseListType);
